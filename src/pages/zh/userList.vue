...
<template>
    <div class="content">
        <div class="sort">
            <div class="top_wrap">
                <el-input style="float:left; width:200px;margin-right:20px" v-model="httpParam.fullname" placeholder="请输入姓名"></el-input>
                <el-input style="float:left; width:200px;margin-right:20px" v-model="httpParam.phone" placeholder="请输入电话号码"></el-input>
                <el-button style="float:left" type="primary" @click="search()" icon="search">搜索</el-button>
            </div>
        </div>
        <div class="table">
            <el-table align="center" v-bind:data="userList" border style="width:900px;margin:auto" max-height="550" v-loading.body="loading">
