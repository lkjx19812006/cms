    ...
    <div class="content">
        ...
        <div class="table">
            ...
            width:880px;margin:auto" max-height="550" v-loading.body="loading">
                ...
                <el-table-column label="是否开启" width="110">
...
<script>
    ...
    import addVersion from '../../components/version/addERPVersion.vue'
    ...
    function fetchItem(store, val) {
        ...
        return store.dispatch('ERPVersionList', {
            body: body,
            path: url
        });
    }
    ...
    export default {
        ...
        computed: {
            ...
            versionList() {
                return this.$store.state.version.ERPVersionList.list
            },
            total() {
                return this.$store.state.version.ERPVersionList.total
            }
        },
        created() {
            if (this.$store.state.version.ERPVersionList.list.length == 0) {
                this.getHttp();
            }
        },
        methods: {
            ...
            getHttp() {
                ...
                this.$store.dispatch('ERPVersionList', {
                    body: body,
                    path: url
                }).then(() => {
                    _self.loading = false
