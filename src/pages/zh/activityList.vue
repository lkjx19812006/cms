...
<template>
    <div class="content">
        <div class="sort">
            <div class="top_wrap">
                <el-select style="width:150px;margin-right:20px; float: left" v-model="httpParam.state"
                           placeholder="请选择">
                    <el-option v-for="item in state" :label="item.label" :value="item.value">
                    </el-option>
                </el-select>
                <el-input style="width:200px;margin-right:20px;float: left " v-model="httpParam.name"
        ...
        <div class="table">
            <el-table align="center" v-bind:data="activityList" border style="width:1200px;margin:auto" max-height="600"
                ...
                <el-table-column label="操作" width="200">
                    <template scope="scope">
                        ...
                        <el-button @click.native.prevent="updateState(scope.$index)" type="text" size="small"
                                   v-if="scope.row.state=='未启用'">
                            启用
                        </el-button>
                        <el-button @click.native.prevent="updateState(scope.$index)" type="text" size="small"
                        ...
                        <el-button @click.native.prevent="goUp(scope.$index)" type="text" size="small"
                                   v-if="scope.$index > 0 && scope.row.state=='启用'">
                            上移
                        </el-button>
                        <el-button @click.native.prevent="goDown(scope.$index)" type="text" size="small"
                                   v-if="scope.$index < activityList.length - 1 && scope.row.state=='启用'">
                            下移
                        </el-button>
                    </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            edit(index) {
                ...
                let Reg5 = /YCMMPublishSupplyViewController/;//资源发布页
                let Reg6 = /YCMMPublishDemandViewController/;//求购发布页
                ...
                } else if (Reg5.test(this.activityList[index].shareUrl)) {
                    this.activityDetail.appActivUrl = '3'
                } else if (Reg6.test(this.activityList[index].shareUrl)) {
                    this.activityDetail.appActivUrl = '4'
                } else {
                    this.activityDetail.appActivUrl = '0'
                }
