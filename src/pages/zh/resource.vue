...
<template>
    <div class="content">
        ...
        <div class="table">
            <el-table align="center" v-bind:data="resourceList" border style="width:1106px;margin:auto" max-height="500" @selection-change="handleSelectionChange" :v-loading.body="loading">
